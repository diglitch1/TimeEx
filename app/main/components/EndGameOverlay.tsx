...
export default function EndGameOverlay({
    ...
    return (
        ...
        >
            ...
            <div
                className={`relative rounded-[36px] border border-[#CFE3F8] bg-white/78 px-10 py-10 text-center shadow-[0_26px_70px_rgba(15,23,42,0.10)] backdrop-blur-md transition-all duration-700 ${
            ...
            >
                <Image
                    ...
                    width={640}
                    height={240}
                    className="mx-auto h-auto w-[min(540px,82vw)]"
                    priority
                />
