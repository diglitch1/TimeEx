...
const DIALOGUE_LINES = [
    'Breaking news: Pfizer and BioNTech report highly promising COVID-19 vaccine results.',
    'After months of uncertainty, the announcement gives markets their first clear signal that economies may eventually reopen.',
    'Travel and airline stocks surge as investors react to reopening hopes.',
    'This is the first real sign that flying might return - but damaged airlines and uncertain jobs mean the future is still not guaranteed.',
];

const TYPE_SPEED = 42;
const DIALOGUE_DELAY_MS = 3000;

export default function VaccineAnnouncedModal({ onClose }: Props) {
    ...
    const currentImageSrc =
        lineIndex >= 2
            ? '/images/scenario-events/news-live4.2.png'
            : '/images/scenario-events/news-live4.1.png';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className="news-event-modal bg-white rounded-2xl text-gray-900 shadow-xl animate-event-in">
                <h2 className="mb-3 text-center text-2xl font-bold text-red-600">
                    Vaccine Breakthrough Sends Markets Higher
                </h2>

                <div className="mb-4">
                    <p className="news-event-copy mb-3">
                        Pfizer and BioNTech announce strong vaccine trial results. Markets react
                        positively, especially sectors that were damaged by lockdowns and travel
                        restrictions.
                    </p>
                    ...
                    <div className="relative">
                        <div className="news-event-frame flex justify-center">
                            <img
                                src={currentImageSrc}
                                alt="Live market news broadcast showing a vaccine rally"
                ...
                <div className="mb-4">
                    ...
                    <div className="border border-gray-300 rounded-xl p-3 bg-white text-gray-800">
                        This is the moment when a health emergency turns into a direct economic shock
                        for global travel and aviation.
                    </div>
                </div>
